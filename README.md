...
python -m src.main --domain_name=arm_10d --qd_config_name=112k --model_config_name=arm_10d_vae --train_batch_size=64 --num_training_iters=100 --optimizer-name=adam --lr_g=1e-4
```